...
public class Billing extends Application {
    ...
    public void start(Stage stage) throws MalformedURLException, SQLException {
        ...
        try {
            connect = DriverManager.getConnection("jdbc:mysql://localhost:3306/billing", "root", "!Birbir7976");
    ...
    public GridPane addGrdGraph() throws SQLException {
        ...
        try {
            connect1 = DriverManager.getConnection("jdbc:mysql://localhost:3306/billing", "root", "!Birbir7976");
        } catch (SQLException ex) {
            ex.printStackTrace();
        }
